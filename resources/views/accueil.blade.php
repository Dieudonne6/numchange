                    ...
                    <div class="col-12 col-md-6 col-xl-7">
                        <div class="d-flex justify-content-center text-bg-primary">
                            <div class="col-12 col-xl-9">
                                ...
                                <p class="lead mb-5" style="text-align: justify">Chers utilisateurs, avec le récent changement dans la numérotation des téléphones dans
                                    notre pays, passant de 8 chiffres à 10 chiffres, notre application est là pour
                                    simplifier cette transition. Nous vous permettons de convertir
                                    facilement et rapidement les numéros existants vers le nouveau format à 10 chiffres.</p>
                                <div class="text-endx">
                                ...
                                <p> Prenez quelques secondes pour mettre à jour votre numéro de téléphone dès maintenant
                                    afin de ne rien manquer.</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body p-3 p-md-4 p-xl-5">
                                ...
                                <div class="row">
                                    <div class="col-12 text-center">
                                        <img class="img-fluid rounded text-center" loading="lazy"
                                            src="assets/images/lkoo-removebg-preview.png" width="350" height="70"
                              ...
                              <label for="email" class="form-label">+229</label> --}}
                                                    <input type="text" class="form-control pt-2" id="code"
                                                        value="+229" readonly style="width: 70px">

                                                </div>
                                                <div class="form-floating mb-3 col-9">
                                                    <input type="tel" class="form-control" name="number"
                                                        minlength="8" maxlength="8" pattern="\d{1,8}" id="phone"
                                        ...
                                        <div class="col-12">
                                            <div class="d-grid">
                                                <button class="btn btn-primary btn-lg" type="submit">Mettre à
                                                    jour</button>
                                            </div>
                                        </div>
                                    </div>
